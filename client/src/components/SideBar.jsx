    ...
    return (
      <div>
        <div className='p-4 pb-0 mx-auto flex flex-wrap justify-center items-center'>
          <div className='p-4 w-full lg:w-3/4 bg-gray-800'>
            <div className='p-4 text-gray-700 bg-gray-900 rounded-lg shadow-lg font-medium'>
              <span className='px-2 mr-2 border-r border-gray-800'>
                ...
                />
                <span className='font-medium text-sm text-gray-400 pl-2'>
                  Let's Trade
                </span>
              </span>
              <span className='px-2 py-1 cursor-pointer bg-gray-800 text-gray-300 text-sm rounded mb-5'>
